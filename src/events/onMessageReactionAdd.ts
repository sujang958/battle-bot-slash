const { MessageAttachment, Collection, Message, MessageReaction, User } = require('discord.js')
...
module.exports = {
   ...
   */
	async execute(client, messageReaction, user) {
		...
		const logChannel = messageReaction.message.guild.channels.cache.get(LoggerSettingDB.guild_channel_id)
